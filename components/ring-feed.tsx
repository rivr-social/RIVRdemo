...
import { mockRings, mockFamilies, users as mockUsers } from "@/lib/mock-data"
...
export function RingFeed({
  ...
  // If rings is not provided, use mock data
  useEffect(() => {
    let ringsToUse = rings || mockRings
  ...
  const getFamiliesForRing = (ringId: string) => {
    const familiesToUse = families || mockFamilies
            ...
            <CardContent className="p-4 pt-0 bg-white">
              ...
              <div className="space-y-2">
                <div className="flex items-center text-sm">
                  ...
                  <span>{ring.chapterTags?.[0] || "Location not specified"}</span>
                </div>
                <div className="flex items-center text-sm">
