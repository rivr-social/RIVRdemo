...
export function GroupJoinSettings({ group, onSave, isAdmin }: GroupJoinSettingsProps) {
  const [joinSettings, setJoinSettings] = useState(group.joinSettings)
  ...
  const handleQuestionChange = (id: string, field: keyof JoinQuestion, value: any) => {
            ...
            {joinSettings.joinType === JoinType.InviteOnly && (
              <div className="p-3 border rounded-md">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button size="icon" variant="outline" onClick={copyInviteLink} disabled={!joinSettings.inviteLink}>
              ...
              questions.length > 0 && (
                <div className="p-3 border rounded-md">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setExpandedQuestions(!expandedQuestions)}>
