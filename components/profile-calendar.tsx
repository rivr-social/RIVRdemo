...
import { ChevronLeft, ChevronRight, Calendar, Clock, MapPin, Users, ExternalLink, Building2, Briefcase, PartyPopper, Wrench } from "lucide-react"
import { JobShift } from "@/lib/mock-job-shift-data"
...
const getTypeColor = (type: 'shift' | 'event' | 'service', priority?: string) => {
  switch (type) {
    case 'shift': 
        ...
        <Card>
          ...
          <CardContent>
                  ...
                  {weekDays.map((day, index) => {
                    ...
                    return (
                      <div key={index} className="border rounded-lg">
                        <div 
                          className={`
                            p-2 text-center border-b cursor-pointer hover:bg-gray-100 transition-colors
                        ...
                        >
                          ...
                          <div className={`text-lg font-bold ${isToday ? 'text-blue-900' : ''}`}>
                            {day.getDate()}
                          </div>
                        </div>
                        <div 
            ...
            <div className="flex flex-wrap items-center gap-4 mt-4 pt-4 border-t">
              <span className="text-sm text-gray-600">Item Types:</span>
