      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 bg-gray-100 rounded-full p-2 pl-4 mb-6">
          <div className="flex-1">
            <input type="text" placeholder="Search family name" className="bg-transparent w-full focus:outline-none" />
          </div>
        </div>

        <Link href="/families/create" className="flex items-center gap-3 mb-6">
