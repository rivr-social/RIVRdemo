...
export default function EventDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const event = projects.find((p) => p.id === resolvedParams.id) || projects[0]
  ...
  useEffect(() => {
    ...
    const updates = mockPosts
      .filter((post) => post.eventId === resolvedParams.id || post.content.includes(event.name))
      .map((post) => ({
        ...post,
  ...
  }, [resolvedParams.id, event.name, creator.id])
        ...
        <div className="flex-1">
          ...
          <div className="bg-white p-6 mb-6">
            ...
            <Button
              ...
              onClick={() => router.push(`/events/${resolvedParams.id}/tickets`)}
            >
              Register
            </Button>
            ...
            {canEditEvent && (
              <Button
                ...
                onClick={() => router.push(`/events/${resolvedParams.id}/edit`)}
              >
                Edit Event
              </Button>
            )}
            ...
            <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab} value={activeTab}>
              ...
              <div className="p-6">
                ...
                <TabsContent value="discussion" className="mt-0">
                  ...
                  <CommentFeed eventId={resolvedParams.id} />
                </TabsContent>

                <TabsContent value="updates" className="mt-0">
                  <h2 className="text-xl font-semibold mb-4">Event Updates</h2>
                  {/* Add CreatePost component for updates */}
                  <CreatePost eventId={resolvedParams.id} onPostCreated={handlePostCreated} />
